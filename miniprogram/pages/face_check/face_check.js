...
Page({
  data: {
    ...
    elements: [
      { title: '校园卡注册', name: 'Step1', leibie:'camera' , color: 'purple', icon: 'vipcard' },
      { title: '人脸验证 ', name: 'Step2', leibie:'camera' ,color: 'mauve', icon: 'formfill' },
      { title: '确定拍照', name: 'Yes', leibie:'cansole_or_accurate' , color: 'cyan', icon: 'roundcheckfill' },
      { title: '取消拍照', name: 'No', leibie:'cansole_or_accurate',color: 'orange', icon: 'close' },
    ],
    src:'',
    show_camera:false,
        ...
        wx.uploadFile({
          ...
          success(res) {
            if (res.statusCode != 200) {
              ...
              if(ckeck=='www.ecard.ecnu.edu.cn'){
